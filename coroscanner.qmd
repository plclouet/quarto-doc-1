...
| Examen                               | Type d’information          | Points forts                                     | Principales limites                                      |
|-------------------------------------|------------------------------|-------------------------------------------------|---------------------------------------------------------|
| **Coroscanner (CCTA)**              | Anatomique                   | VPN très élevée, non invasif, analyse des plaques | Irradiant, produit iodé, spécificité réduite si calcium |
| **Épreuve d’effort ECG**            | Fonctionnelle                | Simple, peu coûteuse                             | Sensibilité/spécificité limitées                        |
| **Échocardiographie de stress**     | Fonctionnelle                | Non irradiant, bonne évaluation du myocarde      | Opérateur-dépendant, fenêtre acoustique parfois limitée |
| **Scintigraphie myocardique**       | Fonctionnelle                | Bonne sensibilité pour ischémie                  | Irradiant, disponibilité variable                       |
| **IRM cardiaque de stress**         | Fonctionnelle + tissulaire   | Excellente résolution tissulaire, non irradiant  | Plus longue, contre-indications IRM possibles           |
| **Coronarographie invasive**        | Anatomique + thérapeutique   | Gold standard, possibilité d’angioplastie        | Invasive, risques de complications, hospitalisation     |
...
## 11. Exemples de compte-rendu simplifié

### 11.1 Coroscanner normal

> **Conclusion :** artères coronaires sans sténose significative.  
> Calcium coronaire absent ou minime.  
> Aucune anomalie de naissance ou de trajet.  
> Aspect rassurant, pas d’argument en faveur d’une maladie coronarienne obstructive.

### 11.2 Sténose intermédiaire

> **Conclusion :** plaque mixte au niveau du segment moyen de l’IVA, responsable d’un rétrécissement estimé à 50 %.  
> Autres segments sans sténose significative.  
> Discussion d’un examen fonctionnel complémentaire (échocardiographie de stress, scintigraphie, IRM de stress) selon le contexte clinique.

### 11.3 Sténose sévère

> **Conclusion :** sténose serrée (> 70 %) de l’IVA proximale liée à une plaque non calcifiée.  
> Recommandation de coronarographie invasive en vue d’une éventuelle revascularisation.

***

La classification CAD-RADS résume la conclusion
